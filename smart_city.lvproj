...
<Project Type="Project" LVVersion="19008000">
	...
	<Item Name="KULAK-WPSP-RIO5" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">KULAK-WPSP-RIO5</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="afslaan_proberen_deel2(SubVI).vi" Type="VI" URL="../../afslaan_proberen_deel2(SubVI).vi"/>
		<Item Name="afslag_aan_het_kruispunt (SubVI).vi" Type="VI" URL="../../afslag_aan_het_kruispunt (SubVI).vi"/>
		<Item Name="keuzestopvolglijn (SubVI).vi" Type="VI" URL="../../keuzestopvolglijn (SubVI).vi"/>
		<Item Name="licht_op_groen (SubVI).vi" Type="VI" URL="../../licht_op_groen (SubVI).vi"/>
		<Item Name="lijnvolgen (SubVI).vi" Type="VI" URL="../../lijnvolgen (SubVI).vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="motor_uittesten (SubVI).vi" Type="VI" URL="../../motor_uittesten (SubVI).vi"/>
		<Item Name="reflectiesensor (SubVI).vi" Type="VI" URL="../../reflectiesensor (SubVI).vi"/>
		<Item Name="subvi_subvi (SubVI).vi" Type="VI" URL="../../subvi_subvi (SubVI).vi"/>
		<Item Name="Untitled 1 (SubVI).vi" Type="VI" URL="../../Untitled 1 (SubVI).vi"/>
		<Item Name="versnelling (SubVI).vi" Type="VI" URL="../../versnelling (SubVI).vi"/>
		<Item Name="vertragen (SubVI).vi" Type="VI" URL="../../vertragen (SubVI).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="initializeRGB_SubVI.vi" Type="VI" URL="../../initializeRGB_SubVI.vi"/>
			<Item Name="lijnvolgen_deel2 (SubVI).vi" Type="VI" URL="../../lijnvolgen_deel2 (SubVI).vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="manualoverride_deel2 (SubVI).vi" Type="VI" URL="../../manualoverride_deel2 (SubVI).vi"/>
			<Item Name="NiFpgaLv.dll" Type="Document" URL="NiFpgaLv.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="optelling_afslagen_deel2(SubVI).vi" Type="VI" URL="../../optelling_afslagen_deel2(SubVI).vi"/>
			<Item Name="reflectiesensor_lezen (SubVI).vi" Type="VI" URL="../../reflectiesensor_lezen (SubVI).vi"/>
			<Item Name="RGBlezenfinaal.vi" Type="VI" URL="../../RGBlezenfinaal.vi"/>
			<Item Name="som_deel2 (SubVI).vi" Type="VI" URL="../../som_deel2 (SubVI).vi"/>
			<Item Name="vertragen_versnellen_Deel2 (SubVI).vi" Type="VI" URL="../../vertragen_versnellen_Deel2 (SubVI).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
